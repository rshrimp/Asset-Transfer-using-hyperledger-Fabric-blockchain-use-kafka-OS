...
docker exec cli.Org1 bash -c 'peer channel create -c test -f ./channels/test.tx -o orderer0.transfer.com:7050 --timeout 30'
...
docker exec cli.Org1 bash -c 'peer channel update -o orderer0.transfer.com:7050 -c test -f ./channels/testanchor.tx'
sleep ${FABRIC_START_WAIT}
